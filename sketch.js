...
function setup() {
  ...
  ground = createSprite(windowWidth,windowHeight/2,400,20);
  ...
  invisibleGround = createSprite(200,windowWidth/3.7,400,10);
...
function draw() {
  //trex.debug = true;
  background(255);
  text("Score: "+ score, windowWidth/1.10,50);
...
function spawnObstacles() {
  if(frameCount % 70 === 0) {
    var obstacle = createSprite(windowWidth,windowHeight/2.05,10,40);
    //obstacle.debug = true;
